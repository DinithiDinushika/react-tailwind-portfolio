            ...
            <div className="w-full lg:w-1/2">
                <div className="flex flex-col items-center lg:items-start">
                    ...
                    <motion.span 
                        ...
                        initial="hidden"
                        animate="visible"
                        className='text-3xl tracking-tight text-transparent bg-gradient-to-r from-pink-300 via-slate-500 to-purple-500 bg-clip-text'>Full Stack Developer</motion.span>
                    <motion.p 
